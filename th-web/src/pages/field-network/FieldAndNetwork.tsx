...
const FieldAndNetwork = () => {
                ...
                <div className="p-4 flex flex-col items-center">
                    <div className="mb-4">
                        <img
                            src={image}
                            alt="placeholder"
                            className="w-96 h-48 rounded-img-letter object-cover"
                        />
                    </div>
                    <div>
                        <p className="text-lg">
    ...
    return (
        <div className="container mx-auto p-8 bg-gray-100">
            ...
            <div className="flex justify-center bg-blue-500 rounded-img-field">
                <div className="w-1/2 rounded-img-letter bg-gray-100 p-2">
                    <img
                        src={GR56}
                        alt="placeholder"
                ...
                <div className="bg-blue-500 text-white pb-8">
                    <div className="flex justify-center m-8 p-8">
                        <p className="p-12 text-xl border border-gray-300 rounded-lg">
                            Cùng với đội ngũ thuyền trưởng, thuyền viên đào tạo chuyên nghiệp,
                            nhiệt tình, năng động và có trách nhiệm và là một trong những đối
                            tác tin cậy, lâu dài của mọi người. Quý khách hàng sẽ cảm thấy
                            thật sự an tâm khi sử dụng dịch vụ vận tải của chúng tôi. Sự hài
                            lòng của khách hàng chính là sự thể hiện niềm tin và uy tín nhất
                            của chúng tôi.
                        </p>
                    </div>
                    <div className="flex justify-center ">
                        <p className="text-lg font-bold mt-4">
                            DỊCH VỤ VẬN TẢI BẰNG ĐƯỜNG THỦY NỘI ĐỊA TRƯỜNG HƯNG CHUYÊN CHỞ
                            CÁC MẶT HÀNG:
                        </p>
                    </div>
                </div>
            ...
            <div className="mb-8 mt-8">
                ...
                <div className="border-2 border-blue-500 rounded-top-right-bot-left p-8 mb-4">
